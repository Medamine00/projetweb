  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Tables</h5>
            <?php
// Include the database connection
include 'index.php';

// Fetch all formations
$sql = "SELECT id_formation, nom_formation, description_formation, duration_formation, id_cours, id_certification FROM Formation";
                ...
                <table class="table text-nowrap align-middle mb-0">
                    <thead>
                        <tr class="border-2 border-bottom border-primary border-0">
                            <th scope="col" class="ps-0">Nom de la Formation</th>
                            <th scope="col">Description</th>
                            <th scope="col" class="text-center">Durée (heures)</th>
                            <th scope="col" class="text-center">ID du Cours</th>
                            <th scope="col" class="text-center">ID de la Certification</th>
                    ...
                    <tbody class="table-group-divider">
                        <?php foreach ($formations as $formation): ?>
                            <tr>
                                ...
                                <td class="text-center fw-medium"><?php echo htmlspecialchars($formation['duration_formation']); ?></td>
                                <td class="text-center fw-medium"><?php echo htmlspecialchars($formation['id_cours']); ?></td>
                                <td class="text-center fw-medium"><?php echo htmlspecialchars($formation['id_certification']); ?></td>
                                <td class="text-center fw-medium">
                                    <form action="supprimeFormation.php" method="POST" style="display:inline;">
