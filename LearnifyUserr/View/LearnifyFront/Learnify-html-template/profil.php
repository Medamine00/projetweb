...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="front.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="front.php" class="nav-item nav-link">Home</a>
                <a href="profil.php" class="nav-item nav-link active">Profile</a>
                <a href="../../../Controller/UserController.php?action=logout" class="btn btn-primary py-2 px-4">Logout</a>
            </div>
        </div>
    </nav>
    <!-- Navbar End -->
